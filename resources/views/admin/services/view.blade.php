      ...
      <div class="card">
        ...
        <div class="card-body">
                  ...
                  <div class="col-md-12">
                     ...
                     <div class="post">
                        ...
                        <ul class="cus-info">
                           ...
                           <li><span>Make:</span> {{$result->make}}</li>
                           <li><span>Model:</span> {{$result->model}}</li>
                           <li><span>Serial Number:</span> {{$result->serial_number}}</li>
                           <li><span>Request Type:</span> {{$result->request_type}}</li>
                           <li><span>Issue:</span> <span class="cus-message">{{$result->issue}}</span></li>
                           <li></li>
                        </ul>
                     </div>
                  </div>
          ...
          <div class="card-footer">
              <div>
                 <a href="{{route('services.index')}}" class="btn btn-primary btn-secondary float-sm-right">Back</a>
              </div>
           </div>
        </div>
        <!-- /.card-body -->
